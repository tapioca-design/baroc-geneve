...
use TapiocaDesign\ClassLiveGnvBundle\Entity\Work;
use TapiocaDesign\ClassLiveGnvBundle\Form\WorkType;
...
class WorkController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TapiocaDesignClassLiveGnvBundle:Work')->findAll();
     ...
     * @Method("POST")
     * @Template("TapiocaDesignClassLiveGnvBundle:Work:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TapiocaDesignClassLiveGnvBundle:Work')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TapiocaDesignClassLiveGnvBundle:Work:edit.html.twig")
     */
