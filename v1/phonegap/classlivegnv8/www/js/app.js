var myApp = angular.module("myApp", 
	["ngRoute", "ngTouch","ngResource","ngAnimate", 'angular-carousel']);
...
myApp.run(function ($rootScope, $location,$http,Const,Data,Navigation) {
    ...
    $rootScope.getData = function (url_suffix,folder,callback) {
        ...
        if (localStorage.getItem(url_suffix) === null) {
            // var url="http://tapiocadesign.com/_CLASSLIVE/v1/symfony/web/bundles/tapiocadesignclasslivegnv/views/json-static-Access-Control-Allow-Origin.php";
